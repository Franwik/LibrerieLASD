...
void Empty(unsigned long & testnum, unsigned long & testerr, const lasd::Container & con, bool chk) {
  bool tst;
  testnum++;
...
void Size(unsigned long & testnum, unsigned long & testerr, const lasd::Container & con, bool chk, unsigned long siz) {
  bool tst;
  testnum++;
